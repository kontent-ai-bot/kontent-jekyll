...
private
  def self.open_struct_values_to_hash(struct)
    hash = {}
  ...
  def self.hash_values_to_hash(hash)
  ...
  def self.stringify_all_keys_in_array(array)
    array.map do |item|
      case item
  ...
  def self.stringify_all_keys_in_hash(hash)
    stringified_hash = {}
    hash.each do |k, v|
  ...
  def self.stringify_all_keys(object)
    case object
  ...
  def self.array_values_to_hash(array)
    array.map do |item|
      case item
